...
public class AdminRegistrationActivity extends AppCompatActivity {
    ...
    private void regAdmin() {
        ...
        if (bloodGroup.equals("Select your blood group")) {
            Toast.makeText(AdminRegistrationActivity.this, "Select blood group", Toast.LENGTH_SHORT).show();
            return;
        } else {
                    ...
                    if (!task.isSuccessful()) {
                        ...
                        userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(AdminRegistrationActivity.this, "Data is set successfully", Toast.LENGTH_SHORT).show();
                                } else {
                        ...
                        Intent intent = new Intent(AdminRegistrationActivity.this, AdminMainActivity.class);
                        startActivity(intent);
                        finish();
                        loader.dismiss();
                    }
